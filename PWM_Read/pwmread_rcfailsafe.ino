...
int RC_min[6] = { 1124,   1016,   1100,   1020,    936,   1116};
int RC_mid[6] = { 1548,   1536,   1540,   1520,   936,   1460};
int RC_max[6] = { 2036,   2028,   2004,   2036,   2100,   1796};

// fail safe positions

float RC_failsafe[] = {0.00, 0.00, 0.00, 0.00, -0.25, 0.00};
...
float RC_decode_trim(float ch_dec) {
  if (ch_dec > 0.7){
    return 1.0; 
  } else if (ch_dec < -0.7){
    return -1.0;
